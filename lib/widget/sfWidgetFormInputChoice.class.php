 ...
 *
 */
class sfWidgetFormInputChoice extends sfWidgetFormChoiceBase
{
  /**
   * Renders the widget.
   *
  ...
  protected function formatChoices($name, $value, $choices, $attributes)
  {
    ...
    foreach ($choices as $label => $value)
    {
      ...
      $inputs[$id] = array(
        'input' => $this->renderTag('input', array_merge(array('type' => 'text', 'name' => $name, 'value' => $value), array_merge($baseAttributes, $attributes))),
